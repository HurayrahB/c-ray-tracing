...
void bouncing_spheres() {
    ...
    auto material_2 = make_shared<lambertian>(colour(0.4, 0.2, 0.1));
    world.add(make_shared<sphere>(point3(-4, 1, 0), 1.0, material_2));

    auto material_3 = make_shared<metal>(colour(0.7, 0.6, 0.5), 0.0);
...
void checkered_spheres() {
    ...
    cam.samples_per_pixel = 100;
    cam.max_depth = 50;
    cam.background = colour(0.7, 0.8, 1);
...
void simple_light() {
    ...
    world.add(make_shared<sphere>(point3(-25, 7, 0), 2, difflight));
